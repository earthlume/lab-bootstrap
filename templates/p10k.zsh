# lab.hoens.fun — Powerlevel10k lean prompt config
# Based on romkatv/powerlevel10k config/p10k-lean.zsh with teal accent.
#
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=030
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=067
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=037
  ...
  # Context color in SSH without privileges — teal to match lab.hoens.fun identity.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=030
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=030

  # Context format when running with privileges: bold user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n@%m'
  # Context format when in SSH without privileges: hostname only (user is always lume).
